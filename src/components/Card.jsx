    ...
    <StyledWrapper>
      <div className="container noselect">
        <div className="canvas">
          ...
          <div id="card" style={{ backgroundImage: `url(${src})` }}>
...
const StyledWrapper = styled.div`
  ...
  .glow-3 {
    ...
    filter: blur(20px); /* Increase blur for more glow */
    opacity: 0;
  ...
  .tracker:hover ~ #card .glowing-elements div {
    opacity: 1;
    filter: blur(25px); /* Increase blur on hover for more glow */
  }
  ...
  #card:hover .corner-elements span {
    ...
    box-shadow: 0 0 15px rgba(92, 103, 255, 0.8); /* Increase box-shadow for more glow */
  }`;
